...
class IncomeForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                Div(model_field_names[12], css_class="col-sm-4"),
                Div(model_field_names[13], css_class="col-sm-4"),
                Div(model_field_names[14], css_class="col-sm-4"),
                css_class="row",
            ),
        )
        self.helper.add_input(Submit("submit", "Submit", css_class="btn-primary"))
        self.helper.form_method = "post"
        self.helper.form_action = "insert-income"
        self.helper.add_input(
            Button(
                "cancel",
                "Cancel",
                css_class="btn-primary",
                onclick="window.location.href = '{}';".format(reverse("income")),
            )
        )
